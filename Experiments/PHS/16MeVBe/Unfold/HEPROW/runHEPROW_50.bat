...
echo ***********************************************************************
echo program now starts with :
faltw Inputs\faltw_50.inp
echo ***********************************************************************
echo +++++++ END of FALTW run, look at protocol in: faltw.log
echo ************************************************************************
pause
cls
move /y MIEKE.MTX MIEKE_50.MTX
move /y MIEKE1.MTX MIEKE1_50.MTX
move /y PROBFlux PROBFlux_50
