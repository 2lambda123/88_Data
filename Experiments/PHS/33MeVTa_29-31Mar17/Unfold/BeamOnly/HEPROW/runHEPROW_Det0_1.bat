...
echo ---------------------------------------------------------------------
echo The input file is named grv_Det0_1.inp
echo ***** There follow the screen output lines, they may here be ignored **
gravelw Inputs\grv_Det0_1.inp
echo ***********************************************************************
...
echo ****************** input file: UNF_Det0_1.inp
echo ***********************************************************************
unfanaw Inputs\unf_Det0_1.inp
echo ***********************************************************************
...
echo ****************** input file: MIK_Det0_1.inp
echo ***********************************************************************
echo program now starts with :
MIEKEW Inputs\mik_Det0_1.inp
echo ***********************************************************************
...
echo ****************** input file: faltw_Det0_1.inp
echo ***********************************************************************
echo program now starts with :
faltw Inputs\faltw_Det0_1.inp
echo ***********************************************************************
echo +++++++ END of FALTW run, look at protocol in: faltw.log
echo ************************************************************************
pause
cls
move /y MIEKE.MTX MIEKE_Det0_1.MTX
move /y MIEKE1.MTX MIEKE1_Det0_1.MTX
move /y PROBFlux PROBFlux_Det0_1
del *.$$$
del Inputs\*.$$$
